...
const LoginComponents = () => {
  ...
  return (
    <div className="h-screen  relative  w-full flex items-center justify-center  px-4 bg-white">
  
      <div className="backdrop-blur bg-black p-8 rounded-3xl shadow-2xl w-full max-w-md border border-white/20">
